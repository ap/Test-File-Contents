...
test_diag("File aaa.txt does not match string provided");
test_fail(+1);
file_contents_is("aaa.txt", "bbb");
...
file_contents_like("aaa.txt", qr/[abc]/, "aaa regexp test");
test_test("works when correct");

test_out("ok 1 - file contents match regexp");
file_contents_like("aaa.txt", qr/[abc]/);
test_test("works when correct with default text");

test_out("not ok 1 - file contents match regexp");
test_diag("File aaa.txt does not match regexp provided");
test_fail(+1);
file_contents_like("aaa.txt", qr/[xyz]/);
...
# md5sum for aaa.txt is 5c9597f3c8245907ea71a89d9d39d08e

ok(defined(&file_md5sum),"function 'file_md5sum' exported");

test_out("ok 1 - aaa md5sum test");
file_md5sum("aaa.txt", "5c9597f3c8245907ea71a89d9d39d08e", "aaa md5sum test");
test_test("file_md5sum works when correct");

test_out("ok 1 - file matches md5sum");
file_md5sum("aaa.txt", "5c9597f3c8245907ea71a89d9d39d08e");
test_test("file_md5sum works when correct with default text");

test_out("not ok 1 - file matches md5sum");
test_diag("File aaa.txt has md5sum 5c9597f3c8245907ea71a89d9d39d08e not 0123456789abcdef0123456789abcdef");
test_fail(+1);
file_md5sum("aaa.txt", "0123456789abcdef0123456789abcdef");
